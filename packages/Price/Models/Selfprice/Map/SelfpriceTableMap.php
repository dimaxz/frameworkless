...
namespace Price\Models\Selfprice\Map;

use Price\Models\Selfprice\Selfprice;
use Price\Models\Selfprice\SelfpriceQuery;
...
class SelfpriceTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Price.Models.Selfprice.Map.SelfpriceTableMap';
     ...
     */
    const OM_CLASS = '\\Price\\Models\\Selfprice\\Selfprice';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Price.Models.Selfprice.Selfprice';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Price\\Models\\Selfprice\\Selfprice');
        $this->setPackage('Price.Models.Selfprice');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Price\Models\Selfprice\Selfprice) { // it's a model object
