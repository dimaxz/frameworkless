 ...
 *
 *
* @package    propel.generator.Price.Models.Selfprice.Base
*/
abstract class Selfprice implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Price\\Models\\Selfprice\\Map\\SelfpriceTableMap';
    ...
    /**
     * Initializes internal state of Price\Models\Selfprice\Base\Selfprice object.
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Price\\Models\\Selfprice\\Selfprice'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Price\Models\Selfprice\Selfprice
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Price\Models\Selfprice\Selfprice (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Price\Models\Selfprice\Selfprice Clone of current object.
     * @throws PropelException
     */
