...
namespace Models\Task\Base;

use \DateTime;
use \Exception;
use \PDO;
use Models\Task\TaskQuery as ChildTaskQuery;
use Models\Task\Map\TaskTableMap;
...
abstract class Task implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Models\\Task\\Map\\TaskTableMap';
    ...
    /**
     * Initializes internal state of Models\Task\Base\Task object.
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Models\\Task\\Task'), 0, $e);
        }
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Models\Task\Task (or compatible) type.
